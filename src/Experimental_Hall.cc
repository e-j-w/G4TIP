...
G4VPhysicalVolume* Experimental_Hall::Construct()
{
  ...
  ExperimentalHall_phys = new G4PVPlacement(0,G4ThreeVector(),
                                      ExperimentalHall_log,"expHall",0,false,0,true);
...
//-----------------------------------------------------------------------------
void Experimental_Hall::setVisible()
{
  ...
  ExperimentalHall_log-> SetVisAttributes (Vis);
   G4cout<<"Experimental Hall is visible"<<G4endl;
}
//-----------------------------------------------------------------------------
