...
class G4IonStoppingData : public G4VIonDEDXTable
{
 public:
  ...
  // files in G4LEDATA
  G4bool BuildPhysicsVector(G4int ionZ, const G4String& matName, const G4bool useCustomPath) override;

  // Function which invokes the read/build process of physics vectors from
  // files in G4LEDATA
  G4bool BuildPhysicsVector(G4int ionZ, G4int matZ, const G4bool useCustomPath) override;
