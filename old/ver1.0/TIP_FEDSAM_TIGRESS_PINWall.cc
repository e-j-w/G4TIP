...
int main(int argc,char** argv) 
{
 ...
 // Construct the outgoing beam
  EvaporationChannel* theEvaporationChannel=new EvaporationChannel();
  theEvaporationChannel->Report();
  EvaporationChannel_Messenger* theEvaporationChannelMessenger;
  theEvaporationChannelMessenger=new EvaporationChannel_Messenger(theEvaporationChannel);
 // set mandatory user action clas
  ...
  RunAction* theRunAction=new RunAction(thePhysicsList,results,theDetector,theEvaporationChannel);
